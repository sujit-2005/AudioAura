      ...
      <section className="home-hero v2-hero">
        ...
        <div className="home-hero__content page-shell">
          ...
          >
            ...
            <img
              src={featuredProduct?.images?.[0]?.url || 'https://images.unsplash.com/photo-1505740420928-5e560c06d30e?auto=format&fit=crop&w=1200&q=85'}
              alt={featuredProduct?.images?.[0]?.altText || 'Premium headphones'}
            />
          </motion.div>
        </div>
        ...
        <section className="page-shell home-section featured-product-section">
          ...
          >
            ...
            <img
              ...
              alt={featuredProduct.images?.[0]?.altText || featuredProduct.name}
            />
          </motion.div>
        </section>
      )}
