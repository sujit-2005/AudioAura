...
const AdminDashboardPage = () => {
  ...
  return (
    <motion.main
      className="page-shell utility-page admin-page"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
    ...
    >
      ...
      <section className="admin-stats">
        {[
          ...
          ['Inventory units', stats.inventory],
          ['Orders', stats.orders],
      ...
      <section className="admin-chart-row">
        <div className="admin-chart glass-panel">
          ...
          <div className="chart-bars" aria-hidden="true">
            {[42, 64, 51, 78, 62, 88, 72].map((height, index) => (
        ...
        <div className="admin-chart glass-panel">
          ...
          <div className="radial-placeholder" aria-hidden="true">
